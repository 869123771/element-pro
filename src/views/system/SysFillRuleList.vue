...
<script>
    ...
    import Modify from './sysFillRuleList/Modify'
    import FunctionalTest from "./sysFillRuleList/FunctionalTest";
    ...
    export default {
        ...
        data() {
            return {
                ...
                fileUpload: {
                    action: apiList.sys_fill_rule_import
                },
            }
        },
        watch: {
        ...
        methods: {
            ...
            add() {
                this.dialog = {
                    ...
                    showCancelBtn : true,
                    showHeader : true,
                    confirmText : this.$t('common_confirm')
                }
                this.component = {
                    ...this.component,
                    is: Modify,
            ...
            async confirmDeleteBatch(ids,event,index) {
                let {success, message} = await http.delete(apiList.sys_fill_rule_delete_batch, {ids})
                if (success) {
            ...
            async fileExport() {
                let params = {}
                let {data, filename} = await http.getFileDownload(apiList.sys_fill_rule_export, params)
            ...
            async queryList() {
                ...
                let {success, result} = await http.get(apiList.sys_fill_rule_query_list, params)
                if (success) {
