<template>
    <el-tabs>
      ...
      <el-tab-pane tab="编辑类图标" key="3">
        <ul>
          <li v-for="icon in icons.editIcons" :key="icon">
            <i :title="icon" @click="chooseIcon(icon)" :class="'iconfont icon-' + icon"/>
          </li>
        </ul>
      </el-tab-pane>
      <el-tab-pane tab="数据类图标" key="4">
        <ul>
